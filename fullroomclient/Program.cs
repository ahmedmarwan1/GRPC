...
try
{
    ...
    // headers.Add("Authorization", "Bearer sdfhhyhasgttdbfkfugghgjjjsdufuysaydsahfl=");
...
catch (Grpc.Core.RpcException ex)
{
    ...
    {
        Console.ForegroundColor = ConsoleColor.Red;
        Console.WriteLine($"Timeout exceeded when trying to join {room} room. Error: {ex.Message}");
        Console.ForegroundColor = ConsoleColor.Gray;
        Console.WriteLine("Press any key to close the window.");
        Console.Read();
        return;
